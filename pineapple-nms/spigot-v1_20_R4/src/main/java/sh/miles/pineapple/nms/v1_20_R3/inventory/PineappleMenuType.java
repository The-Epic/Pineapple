package sh.miles.pineapple.nms.v1_20_R3.inventory;
...
import sh.miles.pineapple.nms.v1_20_R3.inventory.scene.PineappleSceneFactory;

public record PineappleMenuType<T extends MenuScene>(NamespacedKey key,
                                                     MenuType<?> handle) implements sh.miles.nms.api.menu.MenuType<T> {
